...
$$\begin{align}
e_{t+h}^{a}=y_{t+h}-\hat{y}_{t+h}^{a} \\
e_{t+h}^{b}=y_{t+h}-\hat{y}_{t+h}^{b} \\
e_{t+h}^{c}=y_{t+h}-\hat{y}_{t+h}^{c}
\end{align}$$

| model | $e_{1}$ | $e_{2}$ | $e_{3}$ | $\sum e$ (don't use this) | $\sum \frac{e^{2}}{3}$ | $\sum \frac{\lvert e \rvert}{3}$ |
| ----- | ------- | ------- | ------- | ------------------------- | ---------------------- | -------------------------------- |
