...
[[programs in memory|memory layout]] while `get_input()` runs:
...
## protection
the biggest protection that modern computers have taken is implementing an [[access control mechanisms|access-control mechanism]] that **disallows stack execution**. 
