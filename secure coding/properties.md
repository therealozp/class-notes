...
>[!NOTE]
when a policy is a property, you can look at every execution in isolation, and they should all be "good". normal policies, on the other hand, still require some sort of dependency in programs ("this program is good, given that this program is also able to do this").
...
>[!NOTE] note
this also proves that, **for a policy to be an property, it needs to accept an empty set** (or a policy need to allow a program to do nothing.)
## enforcement
...
## categorization
can be classified into **[[safety properties|safety]]** or **[[liveness properties|liveness]]**, or into the CIA classification. CIA is only used **strictly for properties**, and used in infosec:
