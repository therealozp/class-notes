elasticity is essentially the **ratio of proportion**, which, in all other fields, measures **sensitivity**. then, the elasticity of demand measures how sensitive demand is to price.
